				...
				>
					{WHY_CHOOSE_US.map((point) => (
						<motion.div
							...
							className="bg-gradient-to-br from-white/10 via-black/60 to-black/90 border border-white/10 rounded-xl p-7 flex flex-col items-center shadow-lg hover:scale-[1.03] hover:shadow-2xl transition-all duration-300"
						>
